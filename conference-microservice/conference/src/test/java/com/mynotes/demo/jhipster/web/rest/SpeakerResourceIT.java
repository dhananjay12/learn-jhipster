...
import com.mynotes.demo.jhipster.domain.Speaker;
import com.mynotes.demo.jhipster.repository.SpeakerRepository;
...
public class SpeakerResourceIT {
    ...
    public void createSpeaker() throws Exception {
        ...
        // Create the Speaker
        restSpeakerMockMvc.perform(post("/api/speakers").with(csrf())
    ...
    public void updateSpeaker() throws Exception {
        ...
        restSpeakerMockMvc.perform(put("/api/speakers").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteSpeaker() throws Exception {
        ...
        // Delete the speaker
        restSpeakerMockMvc.perform(delete("/api/speakers/{id}", speaker.getId()).with(csrf())
