...
describe('Service Tests', () => {
  describe('Speaker routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing ISpeaker for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new Speaker(id) })));
        ...
        expect(resultSpeaker).toEqual(new Speaker(123));
      });
