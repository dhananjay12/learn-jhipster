...
describe('Service Tests', () => {
  describe('Session routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing ISession for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new Session(id) })));
        ...
        expect(resultSession).toEqual(new Session(123));
      });
